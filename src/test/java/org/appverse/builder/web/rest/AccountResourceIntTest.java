...
import org.appverse.builder.domain.Authority;
import org.appverse.builder.domain.User;
import org.appverse.builder.repository.AuthorityRepository;
...
public class AccountResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(accountResource, "appverseBuilderProperties", appverseBuilderProperties);
        ...
        appverseBuilderProperties.getAuth().setRegistrationEnabled(true);
    }
    ...
    public void testRegisterInvalidEmail() throws Exception {
        ...
        Optional<User> user = userRepository.findOneByLogin("apb");
        assertThat(user.isPresent()).isFalse();
    }
    ...
    public void testRegisterDisabled() throws Exception {
        appverseBuilderProperties.getAuth().setRegistrationEnabled(false);
        ...
        UserDTO u = new UserDTO(
            ...
            true,                   // activated
            "en",                   // langKey
            new HashSet<>(Collections.singletonList(AuthoritiesConstants.USER)) // <-- only admin should be able to do that
        );
        restMvc.perform(
            post("/api/register")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
